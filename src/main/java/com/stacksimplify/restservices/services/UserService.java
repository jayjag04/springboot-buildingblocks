...
public class UserService {
	...
	public User createUser(User user) throws UserAlreadyExistsException {
		...
		if(userExists != null) throw new UserAlreadyExistsException("User already exists; createUser method ");
	...
	public User updateUserById(Long id, User user)  throws UserNotFoundException {
		...
		if(!user1.isPresent()) throw new UserNotFoundException("User not found in in the repo, please provide the corect user id");
		user.setId(id);
		return userRepo.save(user);
	}
